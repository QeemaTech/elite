...
class ElectronicsAdsScreen extends StatefulWidget {
  const ElectronicsAdsScreen({
    super.key,
  });

  @override
  State<ElectronicsAdsScreen> createState() => _ElectronicsAdsScreenState();
}

class _ElectronicsAdsScreenState extends State<ElectronicsAdsScreen> {
  final allfilters = [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          AppbarWithTitleWidget(title: "قسم الالكترونيات"),
          Expanded(
            child: Padding(
